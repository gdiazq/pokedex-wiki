...
import { fetchPokemonJohto } from '@/api/fetchPokemonRegion/fetchPokemonJohto.ts';
      ...
      <main>
        <div className="page-wrap">
          <section className="page-hero">
            <h1 className="page-title">Region Johto</h1>
            <p className="page-subtitle">
              Consulta Pokemon nativos de Johto y revisa sus tipos, habilidades y descripcion.
            </p>
          </section>
