...
export default function RegionPage() {
  ...
  useEffect(() => {
    const loadPokemon = async () => {
      try {
        const fetchedPokemon = await fetchPokemonPaldea();
      ...
      <main>
        <div className="page-wrap">
          <section className="page-hero">
            <h1 className="page-title">Region Paldea</h1>
            <p className="page-subtitle">
              Consulta Pokemon nativos de Paldea y revisa sus tipos, habilidades y descripcion.
            </p>
          </section>
