...
import { fetchPokemonAlola } from '@/api/fetchPokemonRegion/fetchPokemonAlola.ts';
...
export default function RegionPage() {
  ...
  useEffect(() => {
    const loadPokemon = async () => {
      try {
        const fetchedPokemon = await fetchPokemonAlola();
      ...
      <main>
        <div className="page-wrap">
          <section className="page-hero">
            <h1 className="page-title">Region Alola</h1>
            <p className="page-subtitle">
              Consulta Pokemon nativos de Alola y revisa sus tipos, habilidades y descripcion.
            </p>
          </section>
