...
import { fetchPokemonUnova } from '@/api/fetchPokemonRegion/fetchPokemonUnova.ts';
...
export default function RegionPage() {
  ...
  useEffect(() => {
    const loadPokemon = async () => {
      try {
        const fetchedPokemon = await fetchPokemonUnova();
      ...
      <main>
        <div className="page-wrap">
          <section className="page-hero">
            <h1 className="page-title">Region Unova</h1>
            <p className="page-subtitle">
              Consulta Pokemon nativos de Unova y revisa sus tipos, habilidades y descripcion.
            </p>
          </section>
